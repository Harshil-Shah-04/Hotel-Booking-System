        ...
        <form onSubmit={onSubmitHandler}>
            ...
            <div className="w-full flex max-sm:flex-col sm:gap-4 mt-4">
                <div className="flex-1 max-w-48">
                    ...
                    <select name="selectRoomType" value={inputs.roomType} onChange={e => setInputs({...inputs, roomType: e.target.value})} className="border opacity-70 border-gray-300 mt-1 rounded p-2 w-full">
                ...
                <div>
                    ...
                    <input type="number" name="pricePerNight" placeholder="0" className="border border-gray-300 mt-1 rounded p-2 w-24" value={inputs.pricePerNight} onChange={e => setInputs({...inputs, pricePerNight: e.target.value})}/>
                </div>
            </div>
